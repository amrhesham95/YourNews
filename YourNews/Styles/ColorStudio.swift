...
enum ColorStudioName: String, CustomStringConvertible {
    ...
    var description: String {
        // can't use .capitalized because it lowercases the C and P in "cashCallBlue"
...
struct ColorStudio {
    ...
    static let cyan = ColorStudio(name: .cyan)
    static let wooCommerce = ColorStudio(name: .wooCommercePurple)
    static let brand = ColorStudio(name: .wooCommercePurple, shade: .shade50)
    static let purple = ColorStudio(name: .purple)
